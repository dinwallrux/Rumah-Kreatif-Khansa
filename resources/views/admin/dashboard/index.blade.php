...
<head>
    ...
    <title>{{ config('app.name', 'Rumah Kreatif Khansa') }}</title>
    <link href="https://fonts.googleapis.com/css2?family=Cairo:wght@200;300;400;600;700;900&display=swap"
        rel="stylesheet" />
    <link href="{{ asset('css/theme.css') }}" rel="stylesheet">
    <link href="{{ asset('css/admin-tailwind.css') }}" rel="stylesheet">
...
<body>
            ...
            <div class="flex-1 h-full overflow-x-hidden overflow-y-auto">
                ...
                <header class="relative bg-white dark:bg-darker">
                    <div class="flex items-center justify-between p-2 border-b dark:border-primary-darker">
                        ...
                        <a href="index.html"
                            ...
                            Rumah Kreatif Khansa Online Class
                        </a>
                        ...
                        <nav aria-label="Secondary" class="hidden space-x-2 md:flex md:items-center">
                            ...
                            <div class="relative" x-data="{ open: false }">
                                <button @click="open = !open; $nextTick(() => { if(open){ $refs.userMenu.focus() } })"
                                    ...
                                    <img class="w-10 h-10 rounded-full" src="{{ asset('img/sample/avatar.jpg') }}"
                                        alt="Ahmed Kamel" />
                                </button>
                ...
                <main>
                    ...
                    <div
                        ...
                        <h1 class="text-2xl font-semibold">Anak</h1>
                    </div>

                    <!-- Content -->
                    <div class="mt-2">
                        <!-- Charts -->
                        <div class="grid grid-cols-2 p-4 space-y-8 lg:gap-8 lg:space-y-0 lg:grid-cols-2">
                            <!-- Bar chart card -->
                ...
                <footer
                    ...
                    <div>Rumah Kreatif Khansa Online Class &copy; 2021</div>
                </footer>
            </div>
                                ...
                                <div class="flex px-4 space-x-4">
                                    <div class="relative flex-shrink-0">
                                        <span class="relative z-10 inline-block overflow-visible rounded-ful">
                                            <img class="object-cover rounded-full w-9 h-9" src="{{ asset('img/sample/avatar.jpg') }}"
                                                alt="Ahmed kamel" />
                                        </span>
                                        <div
                                            class="absolute h-24 p-px -mt-3 -ml-px bg-primary-50 left-1/2 dark:bg-primary-darker">
                                    ...
                                    <div class="relative flex-shrink-0">
                                        <span class="relative z-10 inline-block overflow-visible rounded-ful">
                                            <img class="object-cover rounded-full w-9 h-9"
                                                src="{{ asset('img/sample/avatar-1.jpg') }}" alt="Ahmed kamel" />
                                        </span>
                                        <div
                                            class="absolute h-24 p-px -mt-3 -ml-px bg-primary-50 left-1/2 dark:bg-primary-darker">
                                        </div>
                                ...
                                <a href="#" class="block">
                                    <div class="flex px-4 space-x-4">
                                        <div class="relative flex-shrink-0">
                                            <span class="relative z-10 inline-block overflow-visible rounded-ful">
                                                <img class="object-cover rounded-full w-9 h-9"
                                                    src="{{ asset('img/sample/avatar.jpg') }}" alt="Ahmed kamel" />
                                            </span>
                                            <div
                                                class="absolute h-24 p-px -mt-3 -ml-px bg-primary-50 left-1/2 dark:bg-primary-darker">
                                            </div>
                ...
                <div class="flex flex-col h-screen">
                    ...
                    <div class="flex-1 px-4 pb-4 space-y-4 overflow-y-hidden h hover:overflow-y-auto">
                        ...
                        <a href="#" class="flex space-x-4">
                            <div class="flex-shrink-0">
                                <img class="w-10 h-10 rounded-lg" src="{{ asset('img/sample/cover.jpg') }}" alt="Post cover" />
                            </div>
                        ...
                        <a href="#" class="flex space-x-4">
                            <div class="flex-shrink-0">
                                <img class="w-10 h-10 rounded-lg" src="{{ asset('img/sample/avatar.jpg') }}" alt="Ahmed Kamel" />
                            </div>
                            <div class="flex-1 max-w-xs overflow-hidden">
                        ...
                        <a href="#" class="flex space-x-4">
                            <div class="flex-shrink-0">
                                <img class="w-10 h-10 rounded-lg" src="{{ asset('img/sample/cover-2.jpg') }}" alt="K-WD Dashboard" />
                            </div>
                            <div class="flex-1 max-w-xs overflow-hidden">
                        ...
                        <template x-for="i in 10" x-key="i">
                            <a href="#" class="flex space-x-4">
                                <div class="flex-shrink-0">
                                    <img class="w-10 h-10 rounded-lg" src="{{ asset('img/sample/cover-3.jpg') }}"
                                        alt="K-WD Dashboard" />
                                </div>
                                <div class="flex-1 max-w-xs overflow-hidden">
                                    <h4 class="text-sm font-semibold text-gray-600 dark:text-light">K-WD Dashboard</h4>
    ...
    <script defer src="{{ asset('js/admin-script.js') }}"></script>
    <script>
        const setup = () => {
            const getTheme = () => {
